  ...
  return (
    <section id="respondents" className="w-full p-6">
      ...
      <div className="mb-8 border-b-2 border-gray-200 pb-4">
        ...
        >
          <FontAwesomeIcon icon={faChartBar} className="mr-2 h-7 w-7 " />
      ...
      <div className="mb-8 overflow-hidden rounded-xl shadow-md bg-white">
        ...
        <div className="p-6">
          <form id="respondentForm" className="space-y-6">
            ...
            >
              <FontAwesomeIcon icon={faSave} className="mr-2 h-7 w-7 " />
      ...
      <div className="mb-8 overflow-hidden rounded-xl shadow-md bg-white">
        <div className="bg-gradient-to-br from-rose-50 to-red-50 border-b border-red-200 p-6">
          <h2 className="text-red-600 text-xl font-bold flex items-center gap-2">
            <FontAwesomeIcon icon={faDatabase} className="mr-2 h-7 w-7 " />
        ...
        <div className="p-6">
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full max-w-md rounded-full border-2 border-gray-200 pl-12 pr-4 py-2 text-base transition focus:outline-none focus:border-red-600 focus:ring-4 focus:ring-red-600/10"
            />
          </div>
